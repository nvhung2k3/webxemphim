@extends('user.master')
@section('title','Phim '.$movie->vie_name.' ('.$movie->eng_name.') - Play&Chill')
@section('content')
<!----------------- Movie list begin -------------------->
<div class="faq">
    <div class="container">
        ...
        <div class="row moviedetail">
            <div class="col-md-4 text-center">
                <img class="img-thumbnail" src="{{'/storage/poster/'.$movie->poster_image}}">
            </div>
            <div class="col-md-4">
                        ...
                        <div class="item">
                            <div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
                                <a href="{{route('user.movie',$item->id)}}" title="{{$item->vie_name.' ('.$item->eng_name.')'}}" class="hvr-shutter-out-horizontal">
                                    <img src="{{'/storage/poster/'.$item->poster_image}}" title="{{$item->vie_name.' ('.$item->eng_name.')'}}" class="img-responsive" alt=" " />
